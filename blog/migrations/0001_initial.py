    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appel_offre_cmd', to='blog.ao')),
                ...
                ('ise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ISE_cmd', to='blog.ise')),
            ],
        ),
        migrations.CreateModel(
            name='Appartenir_A_I',
            fields=[
                ...
                ('ao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appel_offre_ise', to='blog.ao')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='article', to='blog.article')),
                ('cde', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commande_ise', to='blog.cde')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.CharField(max_length=200)),
                ('ao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='appel_offre_da', to='blog.ao')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='article1', to='blog.article')),
                ('cde', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commande_da', to='blog.cde')),
                ...
                ('ise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ISE_da', to='blog.ise')),
            ],
        ),
        migrations.CreateModel(
            name='Appartenir_A_A',
            fields=[
                ...
                ('cde', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commande_ao', to='blog.cde')),
                ...
                ('ise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ISE_ao', to='blog.ise')),
            ],
        ),
        migrations.CreateModel(
            name='Appartenir_P_A',

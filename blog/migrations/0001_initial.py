    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantite_ise', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('montant_DA', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('date_DA', models.DateField(blank=True, null=True)),
                ('quantite_DA', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('date_AO', models.DateField(blank=True, null=True)),
                ('montant_Cde', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('date_Cde', models.DateField(blank=True, null=True)),
                ('quantite_Cde', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ...
                ('fournisseur', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fournisseur', to='blog.fournisseur')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ISE_article', to='blog.ise')),

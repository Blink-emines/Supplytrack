# Generated by Django 5.2.7 on 2025-12-17 14:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_DA', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('famille', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='articles', to='blog.famille')),
            ],
        ),
        migrations.CreateModel(
            name='ISE',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='appel_offre_cmd', to='blog.ao')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='article3', to='blog.article')),
                ('cde', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commande', to='blog.cde')),
                ('da', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='demande_achat_cmd', to='blog.da')),
                ('fournisseur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fournisseur', to='blog.fournisseur')),
                ('ise', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ISE_cmd', to='blog.ise')),
            ],
        ),
        migrations.CreateModel(
            name='Appartenir_A_I',
            fields=[
                ...
                ('ao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='appel_offre_ise', to='blog.ao')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='article', to='blog.article')),
                ('cde', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commande_ise', to='blog.cde')),
                ('da', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='demande_achat_ise', to='blog.da')),
                ('ise', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ISE', to='blog.ise')),
            ],
        ),
        migrations.CreateModel(
            name='Appartenir_A_D',
            fields=[
                ...
                ('destination', models.CharField(max_length=200)),
                ('ao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='appel_offre_da', to='blog.ao')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='article1', to='blog.article')),
                ('cde', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commande_da', to='blog.cde')),
                ('da', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='demande_achat1', to='blog.da')),
                ('ise', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ISE_da', to='blog.ise')),
            ],
        ),
        migrations.CreateModel(
            name='Appartenir_A_A',
            fields=[
                ...
                ('ao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='appel_offre2', to='blog.ao')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='article2', to='blog.article')),
                ('cde', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commande_ao', to='blog.cde')),
                ('da', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='demande_achat_ao', to='blog.da')),
                ('ise', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ISE_ao', to='blog.ise')),
            ],
        ),
        migrations.CreateModel(
            name='Appartenir_P_A',
